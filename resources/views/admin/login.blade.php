                ...
                <div class="limiter">
                    <div class="container m-l-250 m-t-100">
                        <div class="wrap-login100 p-l-50 p-r-50 p-t-20 p-b-20  m-l-190">
                          <h1 class="text-center p-b-5">Login</h1>
                          <p class="text p-b-20">Silahkan login untuk mengakses halaman admin</p>
                                    <form action="{{ url('/loginPost') }}"  method="post">
                                        ...
                                        <a href="#" class="btn-google m-b-10 m-l-90">
                                        ...
                                        <div class="form-group m-t-10">
                                            <button type="submit" class="btn btn-md btn-primary txt1" width="30">Login</button>
                                        </div>
                                    </form>
                        </div>
                    </div>
