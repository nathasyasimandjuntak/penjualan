...
@section('content')
  ...
  <div class="box box-primary" id='panel-add'>
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form action="{{ route('pelangganStore') }}" method="post" enctype="multipart/form-data">
      {{ csrf_field() }}
      ...
      <div class="box-body">
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="kode_pelanggan" id="kode_pelanggan" value="@if($edit == 'true' && !empty($data)) {{ $data->kode_pelanggan }} @endif" placeholder="Kode">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail1">Nama</label>
          <input type="text" class="form-control" name="nama_pelanggan" id="nama_pelanggan" value="@if($edit == 'true' && !empty($data)) {{ $data->nama_pelanggan }} @endif" placeholder="Nama">
        </div>
      </div>
      <!-- /.box-body -->
